...
const Navbar = () => {
  ...
  return (
    <div className='h-[96px] glass-nav px-8 md:backdrop:blur-x1 text-gray-300 max-w-[1200px] flex justify-between items-center mx-auto'>

      <h1 className='text-xl font-bold'><img src={Logo} alt="Cyber-Squad" className='w-16 h-auto'></img></h1>
      ...
      <ul className='hidden md:flex gap-6 text-xl'>
        ...
        <li><Link to="work" spy={true} smooth={true} offset={50} duration={500}>Presentations</Link></li>
      ...
      <div className={nav ? 'text-gray-300 z-40 fixed left-0 top-0 w-full bg-[#232323] ease-in-out duration-500' : 'fixed left-[-100%] '}>
        <ul className='p-8 text-4xl ml-20 z-10'>
          ...
          <li className='p-2'><Link to="work" spy={true} smooth={true} offset={50} duration={500}>Presentations</Link></li>
